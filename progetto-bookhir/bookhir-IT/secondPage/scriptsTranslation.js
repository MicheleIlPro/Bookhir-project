...
function translateToEnglish() {
    ...
    // Footer
    document.querySelector(".fas.fa-gem.me-3.text-secondary").nextSibling.textContent = "Company name";
...
querySelector(".fas.fa-gem.me-3.text-secondary").nextSibling.textContent = "Nome dell'azienda";
