...
<div class="container ">
    ...
    <div class="custom-box">
        <div class="d-flex flex-row align-items-center container " >
                ...
                <button type="submit" class="btn btn-primary"> <?php echo "<a href='create.php?email={$email}' class='btn btn-primary'>" ?>Create a card</a></button>
        ...
        <table class="table table-bordered mt-4">
            ...
            <?php while ($row1 = mysqli_fetch_assoc($result4)) : ?>
                <tr>
                    <td><?php echo $row1["titoloLibro"]; ?></td>
                    <td><?php echo $row1["data_scadenza"]; ?></td>
                </tr>
            <?php endwhile; ?>
            </tbody>
        </table>
